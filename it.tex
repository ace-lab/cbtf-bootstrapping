...
Specifically, our requirements for a ``secure'' Canvas quiz would be:

(list them)

lockdown browsers  - MxN problem, and whack a mole

The correct solution is a combination of a properly configured IP
