...
(Section~\ref{sec:ops}),
and policies/coordination/communication (Section~\ref{sec:policy}).
Due to space constraints and our focus on operational lessons, we do
not discuss the creation and conversion of exam content
from our paper-based exams to PrairieLearn, except to
state that we ended up with exams that were in many ways as rich and
authentic as our paper-based ones, and in some ways significantly
better.
