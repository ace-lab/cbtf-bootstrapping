...
\lesson{No one ``owns''
  funding exam administration as a whole; but each success attracts support, so cast a wide
...
The PIs on the research grant got ourselves invited everywhere we could using every connection we
