...
Three years later, our CBTF operation has grown by
120\%  per semester in seated exam-hours, and now serves
over 5,000 students in departments across campus.
...
might benefit.
Our three main takeaways are as follows.
...
Second, on most campuses no unit ``owns'' exam administration: facilities,
disabled-student accommodations,
instructional technology, and so on are distributed, so you will have to create new
...
boundaries.
Third, our experience shows that the model developed organically and incrementally at
UIUC over several years can be adapted successfully to other
institutions, even under nontrivial bureaucratic, cultural, and space
constraints, without boiling the ocean all at once. 
  
\end{abstract}

\begin{comment}
  %% final abstract plain text:
